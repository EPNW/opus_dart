...
int opus_projection_ambisonics_encoder_get_size(
  ...
  return _opus_projection_ambisonics_encoder_get_size(channels, mapping_family);
}

final _opus_projection_ambisonics_encoder_get_size_Dart
    _opus_projection_ambisonics_encoder_get_size =
    _opus_projection.lookupFunction<
...
int opus_projection_ambisonics_encoder_init(
  ...
  return _opus_projection_ambisonics_encoder_init(
      st, Fs, channels, mapping_family, streams, coupled_streams, application);
}

final _opus_projection_ambisonics_encoder_init_Dart
    _opus_projection_ambisonics_encoder_init = _opus_projection.lookupFunction<
...
final _opus_projection_encode_Dart _opus_projection_encode = _opus_projection
    .lookupFunction<_opus_projection_encode_C, _opus_projection_encode_Dart>(
...
final _opus_projection_encode_float_Dart _opus_projection_encode_float =
    _opus_projection.lookupFunction<_opus_projection_encode_float_C,
...
final _opus_projection_encoder_destroy_Dart _opus_projection_encoder_destroy =
    _opus_projection.lookupFunction<_opus_projection_encoder_destroy_C,
...
int opus_projection_decoder_get_size(
  ...
  return _opus_projection_decoder_get_size(channels, streams, coupled_streams);
}

final _opus_projection_decoder_get_size_Dart _opus_projection_decoder_get_size =
    _opus_projection.lookupFunction<_opus_projection_decoder_get_size_C,
...
ffi.Pointer<OpusProjectionDecoder> opus_projection_decoder_create(
  ...
  return _opus_projection_decoder_create(Fs, channels, streams, coupled_streams,
      demixing_matrix, demixing_matrix_size, error);
}

final _opus_projection_decoder_create_Dart _opus_projection_decoder_create =
    _opus_projection.lookupFunction<_opus_projection_decoder_create_C,
...
final _opus_projection_decoder_init_Dart _opus_projection_decoder_init =
    _opus_projection.lookupFunction<_opus_projection_decoder_init_C,
...
final _opus_projection_decode_Dart _opus_projection_decode = _opus_projection
    .lookupFunction<_opus_projection_decode_C, _opus_projection_decode_Dart>(
...
final _opus_projection_decode_float_Dart _opus_projection_decode_float =
    _opus_projection.lookupFunction<_opus_projection_decode_float_C,
...
final _opus_projection_decoder_destroy_Dart _opus_projection_decoder_destroy =
    _opus_projection.lookupFunction<_opus_projection_decoder_destroy_C,
